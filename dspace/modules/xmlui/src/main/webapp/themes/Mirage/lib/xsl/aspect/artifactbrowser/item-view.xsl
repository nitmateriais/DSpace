        ...
        <tr>
            ...
            <td>
                ...
                <xsl:if test="./@authority and ./@confidence">
                    <a class="ufscar-authority-link" href="/discover?filtertype=author&amp;filter_relational_operator=authority&amp;filter={./@authority}">
                        <xsl:call-template name="authorityConfidenceIcon">
                            <xsl:with-param name="confidence" select="./@confidence"/>
                        </xsl:call-template>
                    </a>
                    <xsl:if test="starts-with(./@authority, 'lattes_')">
                        <a class="ufscar-authority-link" href="http://lattes.cnpq.br/{jstring:replaceAll(string(./@authority),'lattes_','')}">
                            <img class="ds-authority-confidence cf-lattes" src="{$theme-path}/images/authority_control/invisible.gif"/>
                        </a>
                    </xsl:if>
                </xsl:if>
            </td>
