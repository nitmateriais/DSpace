...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/doc:metadata/doc:element[@name='dc']/doc:element/doc:element/doc:field[@name='value']">
        <xsl:call-template name="dimfield">
            ...
            <xsl:with-param name="authority" select="following-sibling::doc:field[@name='authority'][1]"/>
            <xsl:with-param name="confidence" select="following-sibling::doc:field[@name='confidence'][1]"/>
